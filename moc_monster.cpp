...
static const char qt_meta_stringdata_Monster[] = {
    "Monster\0\0MakeTurn()\0"
};
...
const QMetaObjectExtraData Monster::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Monster::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Monster,
      qt_meta_data_Monster, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Monster::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Monster))
        return static_cast<void*>(const_cast< Monster*>(this));
    if (!strcmp(_clname, "Actor"))
        return static_cast< Actor*>(const_cast< Monster*>(this));
